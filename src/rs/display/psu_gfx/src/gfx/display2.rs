...
impl  lnDisplay2  <'_>
{
    ...
    pub fn init(&mut self)
    {
        ...
        self.ili.set_text_color(  ili9341::colors::rgb32(ORANGE)  ,BLACK);
        ...
        self.lcd_print2( SmallFont, SMALL_UNIT_START, SMALL_UNITS_OFFSET, PW_LINE,"W");              
        self.lcd_print2( SmallFont,  SMALL_UNIT_START,SMALL_UNITS_OFFSET, MAX_C_LINE, "A");
        self.lcd_print2( SmallFont,  SMALL_UNIT_START,SMALL_UNITS_OFFSET, VBAT_LINE, "V");
    ...
    pub fn display_current_percent(&mut self, ma : usize, max_ma : usize)
    {
        ...
        self.gauge.draw(percent, &mut self.ili, G_X,G_Y, color);
    ...
    pub  fn display_max_current(&mut self,currentMa: usize) {
        ...
        self.lcd_print(SmallFont, MAIN_COLUMN,SMALL_LIMIT_COLUMN-SMALL_UNITS_OFFSET-MAIN_COLUMN, MAX_C_LINE);     
    }
   
    pub  fn display_power(&mut self, _cc: bool, pw: f32) {
        self.print1f("",pw);
        self.lcd_print(SmallFont, MAIN_COLUMN,SMALL_LIMIT_COLUMN-SMALL_UNITS_OFFSET-MAIN_COLUMN, PW_LINE);    
    }
    ...
    pub  fn display_Vbat(&mut self,vbat: f32) {   
        ...
        self.print1f("",vbat);  
        self.lcd_print(SmallFont, MAIN_COLUMN,SMALL_LIMIT_COLUMN-SMALL_UNITS_OFFSET-MAIN_COLUMN, VBAT_LINE);  
        ...
        self.gauge.draw(per, &mut self.ili, G_X,G_Y2, color);
    }
